package com.buenoezandro.encriptar.senha.autenticacao.jwt;
...
public class DetalheUsuarioData implements UserDetails {
	...
	private final transient Optional<Usuario> usuario;
	...
	public String getUsername() {
		return this.usuario.orElse(new Usuario()).getLogin();
	}
